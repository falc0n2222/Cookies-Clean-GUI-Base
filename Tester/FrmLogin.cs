...
namespace Tester
{
    public partial class FrmLogin : Form
    {
        ...
        {
            if (usernameTxt.Text == "change this to whatever username you want to use" && passwordTxt.Text == "change this to whatever password you wanna use"){
            ...
            } ALSO MAKE SURE TO DELETE REMEMBER ME CHECKBOX AND LABEL
        }
